...
fn fixture_path() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../../tests/fixtures/aerogpu_cmd_copy_texture2d_subrect.aerogputrace")
}
...
fn make_cmd_stream() -> Vec<u8> {
    ...
    // Use render-target usage so we can clear both textures deterministically.
    w.create_texture2d(
        SRC,
    ...
    w.clear(AEROGPU_CLEAR_COLOR, [0.0, 1.0, 0.0, 1.0], 1.0, 0);
...
#[test]
fn aerogpu_cmd_copy_texture2d_subrect_trace_fixture_is_stable() {
