...
fn fixture_path() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../../tests/fixtures/aerogpu_cmd_indexed_triangle.aerogputrace")
}
...
fn make_cmd_stream() -> Vec<u8> {
    ...
    // Fullscreen triangle in solid white.
    //
    // Vertex format: float3 position + float4 color.
    let vertices: [f32; 21] = [
        -1.0, -1.0, 0.0, 1.0, 1.0, 1.0, 1.0, // v0
        -1.0, 3.0, 0.0, 1.0, 1.0, 1.0, 1.0, // v1
        3.0, -1.0, 0.0, 1.0, 1.0, 1.0, 1.0, // v2
    ];
...
#[test]
fn aerogpu_cmd_indexed_triangle_trace_fixture_is_stable() {
