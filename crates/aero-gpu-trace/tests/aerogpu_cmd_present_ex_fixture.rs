...
fn fixture_path() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../../tests/fixtures/aerogpu_cmd_present_ex.aerogputrace")
}
...
fn make_cmd_stream() -> Vec<u8> {
    ...
    w.clear(AEROGPU_CLEAR_COLOR, [0.0, 0.0, 1.0, 1.0], 1.0, 0);

    // Exercise PRESENT_EX (e.g. D3D9-specific flags field) while still producing a deterministic
    // rendered frame.
...
#[test]
fn aerogpu_cmd_present_ex_trace_fixture_is_stable() {
