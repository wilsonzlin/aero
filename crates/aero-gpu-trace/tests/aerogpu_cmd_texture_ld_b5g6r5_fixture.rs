...
fn fixture_path() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .join("../../tests/fixtures/aerogpu_cmd_texture_ld_b5g6r5.aerogputrace")
}
...
fn make_cmd_stream() -> Vec<u8> {
    ...
    // 1x1 B5G6R5 texture with value 0x8410 (a mid-gray in RGB565).
    //
    // Executor expands this to RGBA8 using bit replication:
    // r5=16,g6=32,b5=16 -> rgba8 = [132,130,132,255].
    let texel_b5g6r5: [u8; 2] = 0x8410u16.to_le_bytes();
    ...
    w.upload_resource(TEX, 0, &texel_b5g6r5);
...
#[test]
fn aerogpu_cmd_texture_ld_b5g6r5_trace_fixture_is_stable() {
