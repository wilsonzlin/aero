...
#[test]
fn d3d9_cmd_stream_fixedfunc_poscolor_copy_buffer_preserves_d3dcolor_ordering() {
    ...
    const VB_SRC_HANDLE: u32 = 2;
    const VB_DST_HANDLE: u32 = 3;
    ...
    // for the CopyBuffer path (shadow copy must stay in sync).
