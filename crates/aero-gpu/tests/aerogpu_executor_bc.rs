...
fn executor_upload_bc1_cpu_fallback_and_sample() {
    pollster::block_on(async {
        ...
        let stream = build_stream(|out| {
            ...
            // CREATE_TEXTURE2D (handle=2) 4x4 BC1 texture (sampled).
            ...
            // UPLOAD_RESOURCE: BC1 bytes for texture 2.
            emit_packet(out, AerogpuCmdOpcode::UploadResource as u32, |out| {
                push_u32(out, 2); // resource_handle
                push_u32(out, 0); // reserved0
                push_u64(out, 0); // offset_bytes
                push_u64(out, bc1_solid_red.len() as u64); // size_bytes
                out.extend_from_slice(&bc1_solid_red);
            });
