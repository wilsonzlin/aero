...
#[test]
fn aerogpu_cmd_depth_only_draw_after_destroying_last_rt_still_works() {
    pollster::block_on(async {
        ...
        // - Depth-only pass: z = 0.5
        // - Color pass: z = 0.6, red output, depth test LESS (should be rejected)
        let vertices = [
            // Depth-only pass
            Vertex {
                pos: [-1.0, -1.0, 0.5],
        ...
        // Color pass (should fail depth test).
        writer.set_render_targets(&[C2], D);
