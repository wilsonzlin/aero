...
#[test]
fn aerogpu_cmd_clear_depth_zero_rejects_far_fragments() {
    pollster::block_on(async {
        ...
        // Fullscreen far triangle (green). With depth cleared to 0.0 and depth test LESS, this
        // draw must be rejected (z=0.8 is not < 0.0), leaving the clear color intact.
        let vertices = [
            Vertex {
                pos: [-1.0, -1.0, 0.8],
