...
pub use sm4_ir::{
    ...
    HsDomain, HsOutputTopology, HsPartitioning, OperandModifier, PredicateDstOperand,
    PredicateOperand, PredicateRef, RegFile, RegisterRef, SamplerRef, Sm4CmpOp, Sm4Decl, Sm4Inst,
    Sm4Module, Sm4TestBool, SrcKind, SrcOperand, Swizzle, TextureRef, UavRef, WriteMask,
};
