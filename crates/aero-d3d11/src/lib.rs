...
pub use sm4_ir::{
    BufferKind, BufferRef, CmpOp, CmpType, DstOperand, GsInputPrimitive, GsOutputTopology, HsDomain,
    HsOutputTopology, HsPartitioning, OperandModifier, PredicateDstOperand, PredicateOperand,
    PredicateRef, RegFile, RegisterRef, SamplerRef, Sm4CmpOp, Sm4Decl, Sm4Inst, Sm4Module,
