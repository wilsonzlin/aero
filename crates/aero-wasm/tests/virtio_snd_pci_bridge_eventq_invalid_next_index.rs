...
#[wasm_bindgen_test]
fn virtio_snd_pci_bridge_eventq_retains_event_when_first_chain_next_index_is_out_of_range() {
    ...
    // Descriptor chain 0: NEXT points past the end of the descriptor table.
    ...
    guest.write_u16(avail + 4, 0); // invalid chain
    guest.write_u16(avail + 6, 1); // valid chain
    ...
    // The invalid chain should be completed with len=0, and the event should still be delivered
    // into the valid chain.
