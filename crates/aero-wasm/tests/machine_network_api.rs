...
fn machine_exposes_l2_tunnel_ring_api() {
    ...
    fn assert_attach_sab(_: fn(&mut Machine, js_sys::SharedArrayBuffer) -> Result<(), JsValue>) {}
    ...
    fn assert_stats(_: fn(&Machine) -> JsValue) {}
    ...
    assert_stats(Machine::net_stats);
}

fn build_minimal_io_ipc_sab(
    net_tx_capacity: u32,
    net_rx_capacity: u32,
