...
fn pf008_mem_stride32_checksum() {
    // From `docs/16-guest-cpu-benchmark-suite.md` (PF-008), `mem_stride32` payload bytes.
    let payload: &[u8] = &[
        0xb8, 0xef, 0xcd, 0xab, 0x89, 0x31, 0xf6, 0x8b, 0x14, 0x37, 0x01, 0xd0, 0x31, 0xc2,
...
fn pf008_branch_unpred32_checksum() {
    // From `docs/16-guest-cpu-benchmark-suite.md` (PF-008), `branch_unpred32` payload bytes.
    let payload: &[u8] = &[
