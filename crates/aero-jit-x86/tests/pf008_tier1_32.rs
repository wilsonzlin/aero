...
fn run_pf008_payload_32(
    ...
    let mut steps = 0u64;
    let max_steps = ITERS_PER_RUN.saturating_mul(10).saturating_add(10_000);
...
fn pf008_alu32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0xba, 0x15, 0x7c, 0x4a, 0x7f, 0x01, 0xd0, 0x89, 0xc3, 0xc1,
        0xeb, 0x0d, 0x31, 0xd8, 0xd1, 0xe0, 0x49, 0x75, 0xf2, 0xc3,
    ];
...
fn pf008_branch_pred32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0xbb, 0x15, 0x7c, 0x4a, 0x7f, 0x31, 0xd2, 0x75, 0x02, 0x01,
        0xd8, 0x31, 0xd2, 0x75, 0x02, 0x31, 0xd8, 0xd1, 0xe0, 0x83, 0xc0, 0x01, 0x49, 0x75, 0xec,
        0xc3,
    ];
...
fn pf008_branch_unpred32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xf0, 0xde, 0xbc, 0x9a, 0xbb, 0x08, 0x09, 0x0a, 0x0b, 0x89, 0xc2, 0xc1, 0xe2, 0x0d,
        0x31, 0xd0, 0x89, 0xc2, 0xc1, 0xea, 0x07, 0x31, 0xd0, 0x89, 0xc2, 0xc1, 0xe2, 0x11, 0x31,
        0xd0, 0x89, 0xc2, 0x83, 0xe2, 0x01, 0x74, 0x04, 0x01, 0xc3, 0xeb, 0x04, 0x31, 0xc3, 0xeb,
        0x00, 0x49, 0x75, 0xd9, 0x89, 0xd8, 0xc3,
    ];
...
fn pf008_mem_seq32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xef, 0xcd, 0xab, 0x89, 0x31, 0xf6, 0x8b, 0x14, 0x37, 0x01, 0xd0, 0x31, 0xc2, 0x89,
        0x14, 0x37, 0x83, 0xc6, 0x04, 0x81, 0xe6, 0xff, 0x0f, 0x00, 0x00, 0x49, 0x75, 0xea, 0xc3,
    ];
...
fn pf008_mem_stride32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xef, 0xcd, 0xab, 0x89, 0x31, 0xf6, 0x8b, 0x14, 0x37, 0x01, 0xd0, 0x31, 0xc2, 0x89,
        0x14, 0x37, 0x83, 0xc6, 0x40, 0x81, 0xe6, 0xff, 0x0f, 0x00, 0x00, 0x49, 0x75, 0xea, 0xc3,
    ];
...
fn pf008_call_ret32_checksum_tier1_jit() {
    let code = [
        0xb8, 0xef, 0xbe, 0xfe, 0xca, 0xbb, 0x15, 0x7c, 0x4a, 0x7f, 0xe8, 0x04, 0x00, 0x00, 0x00,
        0x49, 0x75, 0xf8, 0xc3, 0x53, 0x56, 0x01, 0xd8, 0x35, 0xb5, 0x3b, 0x12, 0x1f, 0xc1, 0xe0,
        0x03, 0x5e, 0x5b, 0xc3,
    ];
