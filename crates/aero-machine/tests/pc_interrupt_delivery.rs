...
#[test]
fn pc_machine_e1000_intx_is_synced_even_when_external_interrupt_queue_is_full() {
    let mut pc = PcMachine::new_with_e1000(2 * 1024 * 1024, None);
    ...
    // Fill the external interrupt FIFO to its capacity (1). Even though no additional vectors can
