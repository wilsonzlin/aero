...
struct TooManyMmusSource;

impl snapshot::SnapshotSource for TooManyMmusSource {
    ...
    fn cpu_states(&self) -> Vec<snapshot::VcpuSnapshot> {
        // Multi-vCPU snapshot to force `MMUS` encoding.
        vec![
...
#[test]
fn save_snapshot_rejects_too_many_mmu_states() {
    let mut source = TooManyMmusSource;
...
#[test]
fn restore_snapshot_rejects_too_many_mmus_entries() {
