...
use aero_usb::xhci::{regs as xhci_regs, XhciController};
...
fn xhci_snapshot_does_not_process_halted_active_endpoints_without_device_context() {
    ...
    ctrl.mmio_write(xhci_regs::REG_USBCMD, 4, u64::from(xhci_regs::USBCMD_RUN));
    ...
    restored.mmio_write(xhci_regs::REG_USBCMD, 4, u64::from(xhci_regs::USBCMD_RUN));
