use super::{
    BiosBus, BDA_BASE, BDA_KEYBOARD_BUF_END, BDA_KEYBOARD_BUF_HEAD_OFFSET, BDA_KEYBOARD_BUF_START,
    BDA_KEYBOARD_BUF_TAIL_OFFSET, BIOS_SEGMENT, DEFAULT_INT_STUB_OFFSET,
