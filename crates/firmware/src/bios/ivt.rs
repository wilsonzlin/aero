use super::{
    BiosBus, BDA_BASE, BDA_KEYBOARD_BUF_END, BDA_KEYBOARD_BUF_END_PTR_OFFSET,
    BDA_KEYBOARD_BUF_HEAD_OFFSET, BDA_KEYBOARD_BUF_START, BDA_KEYBOARD_BUF_START_PTR_OFFSET,
    BDA_KEYBOARD_BUF_TAIL_OFFSET, BDA_KEYBOARD_FLAGS_OFFSET, BIOS_SEGMENT,
    DEFAULT_INT_STUB_OFFSET, DISKETTE_PARAM_TABLE_OFFSET, EBDA_BASE, EBDA_SIZE,
    FIXED_DISK_PARAM_TABLE_OFFSET, INT10_STUB_OFFSET, INT13_STUB_OFFSET, INT15_STUB_OFFSET,
    INT16_STUB_OFFSET, INT1A_STUB_OFFSET, IVT_BASE, VGA_FONT_8X8_OFFSET, VIDEO_PARAM_TABLE_OFFSET,
};
...
fn handler_offset(vector: u8) -> u16 {
    match vector {
        ...
        0x1D => VIDEO_PARAM_TABLE_OFFSET,
        0x1E => DISKETTE_PARAM_TABLE_OFFSET,
        0x1F => VGA_FONT_8X8_OFFSET,
...
mod tests {
    use super::*;
    use super::super::{BDA_KEYBOARD_BUF_END, BDA_KEYBOARD_BUF_START};
