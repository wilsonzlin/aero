...
impl IdeChannel {
    ...
    fn read_drive_address(&self) -> u8 {
        // ATA "Drive Address" (DADR) register (control block offset +1).
        //
        // This register is primarily for legacy IDE probing. We implement the ATA/ATAPI defined
        // bit layout:
        //   bits 7..6: 1
