...
pub const FEATURE_TRANSFER: u64 = pci::AEROGPU_FEATURE_TRANSFER;

pub const SUPPORTED_FEATURES: u64 = FEATURE_FENCE_PAGE | FEATURE_CURSOR | FEATURE_SCANOUT | FEATURE_VBLANK;
