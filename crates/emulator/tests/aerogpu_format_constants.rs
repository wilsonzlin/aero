...
const AEROGPU_FORMAT_CASES: &[(ProtocolAerogpuFormat, AeroGpuFormat)] = &[
    ...
    (ProtocolAerogpuFormat::B8G8R8A8Unorm, AeroGpuFormat::B8G8R8A8Unorm),
    (ProtocolAerogpuFormat::B8G8R8X8Unorm, AeroGpuFormat::B8G8R8X8Unorm),
    (ProtocolAerogpuFormat::R8G8B8A8Unorm, AeroGpuFormat::R8G8B8A8Unorm),
    (ProtocolAerogpuFormat::R8G8B8X8Unorm, AeroGpuFormat::R8G8B8X8Unorm),
    (ProtocolAerogpuFormat::B5G6R5Unorm, AeroGpuFormat::B5G6R5Unorm),
    (ProtocolAerogpuFormat::B5G5R5A1Unorm, AeroGpuFormat::B5G5R5A1Unorm),
    (ProtocolAerogpuFormat::D24UnormS8Uint, AeroGpuFormat::D24UnormS8Uint),
