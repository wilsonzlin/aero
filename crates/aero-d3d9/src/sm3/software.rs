...
mod tests {
    ...
    #[test]
    fn collect_used_pixel_inputs_includes_mad_predicate() {
        // Ensure mad still visits instruction modifiers.
        let op = IrOp::Mad {
            dst: Dst {
                reg: RegRef {
                    file: RegFile::Temp,
    ...
    #[test]
    fn collect_used_pixel_inputs_includes_lrp_src2() {
        // Similar to dp2add/mad: `lrp` has three source operands.
        let op = IrOp::Lrp {
            dst: Dst {
                reg: RegRef {
                    file: RegFile::Temp,
