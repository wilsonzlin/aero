...
use aero_devices_gpu::ring::{
    ...
    SUBMIT_DESC_ALLOC_TABLE_GPA_OFFSET, SUBMIT_DESC_ALLOC_TABLE_RESERVED0_OFFSET,
    SUBMIT_DESC_ALLOC_TABLE_SIZE_BYTES_OFFSET, SUBMIT_DESC_CMD_GPA_OFFSET,
    SUBMIT_DESC_CMD_RESERVED0_OFFSET, SUBMIT_DESC_CMD_SIZE_BYTES_OFFSET, SUBMIT_DESC_CONTEXT_ID_OFFSET,
    SUBMIT_DESC_ENGINE_ID_OFFSET, SUBMIT_DESC_FLAGS_OFFSET, SUBMIT_DESC_RESERVED0_OFFSET,
...
fn write_submit_desc(
    ...
    mem.write_u32(
        gpa + SUBMIT_DESC_SIZE_BYTES_OFFSET,
    ...
    mem.write_u64(gpa + SUBMIT_DESC_ALLOC_TABLE_GPA_OFFSET, 0); // alloc_table_gpa
    mem.write_u32(gpa + SUBMIT_DESC_ALLOC_TABLE_SIZE_BYTES_OFFSET, 0); // alloc_table_size_bytes
    mem.write_u32(gpa + SUBMIT_DESC_ALLOC_TABLE_RESERVED0_OFFSET, 0); // alloc_table_reserved0
    mem.write_u64(gpa + SUBMIT_DESC_SIGNAL_FENCE_OFFSET, signal_fence);
    mem.write_u64(gpa + SUBMIT_DESC_RESERVED0_OFFSET, 0); // reserved0
}
