      ...
      try {
        ...
        try {
          ...
          if (micRes.ok) {
            ...
            summaryLines.push(
              `microphone-buffered.wav: samples=${micRes.meta.samplesCaptured} sr=${micRes.meta.sampleRate} backend=${micRes.meta.backend ?? "n/a"} muted=${micRes.meta.muted ?? "n/a"} trackMuted=${micRes.meta.trackMuted ?? "n/a"} trackReadyState=${micRes.meta.trackReadyState ?? "n/a"} deviceIdHash=${micRes.meta.deviceIdHash ?? "n/a"} rms=${formatDbfsFromLinear(micRes.meta.signal.rms)}dBFS peak=${formatDbfsFromLinear(micRes.meta.signal.peakAbs)}dBFS`,
            );
          } else {
