...
function setL2TunnelConnectionState(next: L2TunnelForwarderConnectionState, detail?: string): void {
  if (l2ConnectionState === next) return;
  l2ConnectionState = next;
