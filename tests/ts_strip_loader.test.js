...
const loaderPath = fileURLToPath(new URL("../scripts/ts-strip-loader.mjs", import.meta.url));
...
test("ts-strip-loader: remaps relative .js?query specifiers to .ts equivalents", () => {
  const stdout = execFileSync(process.execPath, ["--experimental-strip-types", "--loader", loaderPath, entryPath], {
    encoding: "utf8",
