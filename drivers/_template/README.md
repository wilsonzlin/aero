...
- `ci-package.json`: starter template (this file is required for CI build+packaging in real driver directories). Add `infFiles` if you need explicit INF selection, and update `wow64Files` as needed.
