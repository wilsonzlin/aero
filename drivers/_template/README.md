...
- `ci-package.json`: starter template (this file is required for CI build+packaging in real driver directories). Replace the `infFiles` placeholder (or remove `infFiles` to enable CI auto-discovery) and update `wow64Files` as needed.
