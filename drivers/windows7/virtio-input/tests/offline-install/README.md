...
>   - If the tablet subsystem ID is missing (or `aero_virtio_tablet.inf` is not staged), the device may bind via the generic fallback
>     and appear as **Aero VirtIO Input Device**.
