...
- The legacy alias INF is a filename alias only.
- From the first section header (`[Version]`) onward, it is expected to be byte-for-byte identical to `inf/aero_virtio_input.inf`
