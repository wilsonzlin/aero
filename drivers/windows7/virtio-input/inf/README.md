...
It also enforces that `aero_virtio_input.inf` does not include the strict generic fallback HWID string anywhere (even in comments),
and does not include the tablet subsystem ID (`SUBSYS_00121AF4`), so tablet
