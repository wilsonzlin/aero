...
legacy alias INF (`drivers/windows7/virtio-input/inf/virtio-input.inf.disabled` → `virtio-input.inf`) to enable the
strict revision-gated generic fallback match (`PCI\VEN_1AF4&DEV_1052&REV_01`).
