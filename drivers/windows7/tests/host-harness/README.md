...
either emulate the subsystem IDs to the contract values or bind via the strict, revision-gated generic fallback entry in
`aero_virtio_input.inf` (`PCI\VEN_1AF4&DEV_1052&REV_01`).
