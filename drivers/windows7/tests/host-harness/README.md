...
to inspect the generated QEMU args. You can also leave `disk_image_path` empty in `dry_run` mode; the workflow will use
a placeholder path for argument generation.
