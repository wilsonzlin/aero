...
class HarnessArgAliasTests(unittest.TestCase):
    ...
    def test_virtio_snd_aliases_set_flag(self) -> None:
        for flag in (
            "--with-virtio-snd",
            "--enable-virtio-snd",
            "--require-virtio-snd",
    ...
    def test_virtio_input_leds_aliases_set_flag(self) -> None:
        for flag in (
            "--with-input-leds",
            ...
            with self.subTest(flag=flag):
                ...
                self.assertTrue(args.with_input_leds)
    ...
    def test_require_net_msix_alias_sets_flag(self) -> None:
        args = self._parse(
            [
                "--qemu-system",
                "qemu-system-x86_64",
    ...
    def test_require_input_msix_alias_sets_flag(self) -> None:
        ...
        self.assertTrue(args.require_virtio_input_msix)
