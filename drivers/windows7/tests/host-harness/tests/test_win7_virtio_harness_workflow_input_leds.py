...
class Win7VirtioHarnessWorkflowInputLedsTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_workflow_declares_input(self) -> None:
        self.assertIn("with_virtio_input_leds:", self.text)

    def test_workflow_passes_with_input_leds_flag(self) -> None:
        ...
        # And ensure the job summary surfaces the corresponding guest marker when present.
