...
def _emit_virtio_net_msix_host_marker(tail: bytes) -> None:
    ...
    The guest selftest may emit:
      AERO_VIRTIO_SELFTEST|TEST|virtio-net-msix|PASS/FAIL/SKIP|mode=...|messages=...|config_vector=...|rx_vector=...|tx_vector=...

    Mirror it into:
      AERO_VIRTIO_WIN7_HOST|VIRTIO_NET_MSIX|PASS/FAIL/SKIP|mode=...|messages=...|config_vector=...|rx_vector=...|tx_vector=...
...
def _emit_virtio_snd_msix_host_marker(tail: bytes) -> None:
    ...
    The guest selftest emits:
      AERO_VIRTIO_SELFTEST|TEST|virtio-snd-msix|PASS/SKIP|mode=...|messages=...|config_vector=...|queue0_vector=...|queue1_vector=...|queue2_vector=...|queue3_vector=...|...

    Mirror it into:
      AERO_VIRTIO_WIN7_HOST|VIRTIO_SND_MSIX|PASS/SKIP|mode=...|messages=...|config_vector=...|queue0_vector=...|queue1_vector=...|queue2_vector=...|queue3_vector=...|...
