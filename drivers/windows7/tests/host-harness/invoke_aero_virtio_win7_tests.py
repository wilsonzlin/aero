...
def _emit_virtio_snd_msix_host_marker(tail: bytes) -> None:
    ...
    The guest selftest emits:
      AERO_VIRTIO_SELFTEST|TEST|virtio-snd-msix|PASS/SKIP|mode=...|messages=...|config_vector=...|queue0_vector=...|queue1_vector=...|queue2_vector=...|queue3_vector=...|interrupts=...|dpcs=...|drain0=...|drain1=...|drain2=...|drain3=...|...

    Mirror it into:
      AERO_VIRTIO_WIN7_HOST|VIRTIO_SND_MSIX|PASS/SKIP|mode=...|messages=...|config_vector=...|queue0_vector=...|queue1_vector=...|queue2_vector=...|queue3_vector=...|interrupts=...|dpcs=...|drain0=...|drain1=...|drain2=...|drain3=...|...
