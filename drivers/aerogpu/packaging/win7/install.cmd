...
rem   install.cmd legacy\aerogpu.inf
rem   install.cmd legacy\aerogpu_dx11.inf
...
if not "%PNP_ERR%"=="0" (
  ...
  echo [WARN]   - If you signed on the build host: run trust_test_cert.cmd ^(next to this script; auto-finds aero-test.cer in parent dirs^), then reboot.
