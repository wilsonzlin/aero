...
int main() {
  ...
  PRINT_OFF_OPT(D3D10DDI_DEVICECALLBACKS, pfnAllocateCb);
  PRINT_OFF_OPT(D3D10DDI_DEVICECALLBACKS, pfnDeallocateCb);
  ...
  PRINT_OFF_OPT(D3D11DDI_DEVICECALLBACKS, pfnAllocateCb);
  PRINT_OFF_OPT(D3D11DDI_DEVICECALLBACKS, pfnDeallocateCb);
  ...
  // Resource creation + allocation contract structs (CreateResource -> AllocateCb).
#if defined(_MSC_VER)
  __if_exists(D3D10DDIARG_CREATERESOURCE) {
    PRINT_SIZE(D3D10DDIARG_CREATERESOURCE);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, NumAllocations);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, pAllocationInfo);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, ResourceDimension);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, Usage);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, BindFlags);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, CPUAccessFlags);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, MiscFlags);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, Format);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, SampleDesc);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, ByteWidth);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, StructureByteStride);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, Width);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, Height);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, MipLevels);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, ArraySize);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, Depth);
    PRINT_OFF_OPT(D3D10DDIARG_CREATERESOURCE, pPrimaryDesc);
    PrintSeparator();
  }
  __if_not_exists(D3D10DDIARG_CREATERESOURCE) {
    printf("%-48s <n/a>\n", "D3D10DDIARG_CREATERESOURCE");
    PrintSeparator();
  }

  __if_exists(D3D11DDIARG_CREATERESOURCE) {
    PRINT_SIZE(D3D11DDIARG_CREATERESOURCE);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, NumAllocations);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, pAllocationInfo);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, ResourceDimension);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, Usage);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, BindFlags);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, CPUAccessFlags);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, MiscFlags);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, Format);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, SampleDesc);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, ByteWidth);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, StructureByteStride);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, Width);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, Height);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, MipLevels);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, ArraySize);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, Depth);
    PRINT_OFF_OPT(D3D11DDIARG_CREATERESOURCE, pPrimaryDesc);
    PrintSeparator();
  }
  __if_not_exists(D3D11DDIARG_CREATERESOURCE) {
  ...
  printf("  %-46s value=%u\n",
         "D3D10DDICAPS_TYPE_MULTISAMPLE_QUALITY_LEVELS",
         (unsigned)D3D10DDICAPS_TYPE_MULTISAMPLE_QUALITY_LEVELS);
  ...
  __if_exists(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS) {
    PRINT_SIZE(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS);
    PRINT_OFF_OPT(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS, Format);
    PRINT_OFF_OPT(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS, SampleCount);
    PRINT_OFF_OPT(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS, Flags);
    PRINT_OFF_OPT(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS, NumQualityLevels);
    PrintSeparator();
  }
  __if_not_exists(D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS) {
    printf("%-48s <n/a>\n", "D3D10DDIARG_MULTISAMPLE_QUALITY_LEVELS");
    PrintSeparator();
  }
  ...
  printf("  %-46s value=%u\n",
         "D3D10_1DDICAPS_TYPE_MULTISAMPLE_QUALITY_LEVELS",
         (unsigned)D3D10_1DDICAPS_TYPE_MULTISAMPLE_QUALITY_LEVELS);
  ...
  __if_exists(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS) {
    PRINT_SIZE(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS);
    PRINT_OFF_OPT(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS, Format);
    PRINT_OFF_OPT(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS, SampleCount);
    PRINT_OFF_OPT(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS, Flags);
    PRINT_OFF_OPT(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS, NumQualityLevels);
    PrintSeparator();
  }
  __if_not_exists(D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS) {
    printf("%-48s <n/a>\n", "D3D10_1DDIARG_MULTISAMPLE_QUALITY_LEVELS");
    PrintSeparator();
  }
  ...
  __if_exists(D3DDDICB_ALLOCATE) {
    ...
    printf("  D3DDDICB_ALLOCATE: CreateResource (resource backing) members\n");
    PRINT_OFF_OPT(D3DDDICB_ALLOCATE, hResource);
    PRINT_OFF_OPT(D3DDDICB_ALLOCATE, hKMResource);
    PRINT_OFF_OPT(D3DDDICB_ALLOCATE, NumAllocations);
    PRINT_OFF_OPT(D3DDDICB_ALLOCATE, pAllocationInfo);
    PRINT_OFF_OPT(D3DDDICB_ALLOCATE, pPrivateDriverData);
  ...
  __if_exists(D3DDDICB_DEALLOCATE) {
    ...
    printf("  D3DDDICB_DEALLOCATE: DestroyResource members\n");
    PRINT_OFF_OPT(D3DDDICB_DEALLOCATE, hResource);
