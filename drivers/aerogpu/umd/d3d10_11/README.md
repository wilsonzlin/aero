...
- Shaders (DXBC payload passthrough):
  ...
  - D3D11: VS/PS/GS/CS (GS binding triggers compute-prepass path; point-list draws can execute a minimal translated SM4 GS subset; other cases fall back to synthetic expansion; see “Geometry shaders (GS)” below)
