...
// Minimal command stream builder for the AeroGPU "IR" defined in aerogpu_cmd.h.
//
// This mirrors the helper used by the D3D9 UMD to keep D3D10/11 command emission
// consistent across UMDs.
class CmdWriter {
 public:
  void reset() {
    buf_.clear();
