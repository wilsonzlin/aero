...
AEROGPU_DEFINE_HAS_MEMBER(pCallbacks)
...
// D3D9 CreateDevice struct (runtime -> UMD) carries a runtime callback table.
AEROGPU_DEFINE_HAS_MEMBER(pCallbacks)

AEROGPU_DEFINE_HAS_MEMBER(pfnAllocateCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnDeallocateCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnGetCommandBufferCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnSubmitCommandCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnRenderCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnPresentCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateDeviceCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroyDeviceCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateContextCb2)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateContextCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroyContextCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroySynchronizationObjectCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnWaitForSynchronizationObjectCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnLockCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnUnlockCb)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetErrorCb)
...
AEROGPU_DEFINE_HAS_MEMBER(NewFenceValue)
AEROGPU_DEFINE_HAS_MEMBER(FenceValue)
AEROGPU_DEFINE_HAS_MEMBER(pFenceValue)
...
// D3D9UMDDI Lock/Unlock arg structs.
AEROGPU_DEFINE_HAS_MEMBER(OffsetToLock)
AEROGPU_DEFINE_HAS_MEMBER(SizeToLock)
AEROGPU_DEFINE_HAS_MEMBER(OffsetToUnlock)
AEROGPU_DEFINE_HAS_MEMBER(SizeToUnlock)

// Present arg structs.
AEROGPU_DEFINE_HAS_MEMBER(hSwapChain)
AEROGPU_DEFINE_HAS_MEMBER(hWnd)
AEROGPU_DEFINE_HAS_MEMBER(hWindow)
AEROGPU_DEFINE_HAS_MEMBER(SyncInterval)
AEROGPU_DEFINE_HAS_MEMBER(hSrc)
AEROGPU_DEFINE_HAS_MEMBER(hSrcResource)
AEROGPU_DEFINE_HAS_MEMBER(hDestResource)

// Lock output structs.
AEROGPU_DEFINE_HAS_MEMBER(pData)
AEROGPU_DEFINE_HAS_MEMBER(rowPitch)
AEROGPU_DEFINE_HAS_MEMBER(slicePitch)
AEROGPU_DEFINE_HAS_MEMBER(pBits)
AEROGPU_DEFINE_HAS_MEMBER(RowPitch)
AEROGPU_DEFINE_HAS_MEMBER(SlicePitch)
...
static void probe_function_tables() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetMaterial)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetLight)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnLightEnable)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetNPatchMode)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetStreamSourceFreq)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetGammaRamp)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnCreateStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDeleteStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnCaptureStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnApplyStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnValidateDevice)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetSoftwareVertexProcessing)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetCursorProperties)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetCursorPosition)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnShowCursor)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetPaletteEntries)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetCurrentTexturePalette)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetClipStatus)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetClipStatus)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetGammaRamp)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawRectPatch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawTriPatch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDeletePatch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnProcessVertices)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetRasterStatus)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetDialogBoxMode)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawIndexedPrimitiveUP)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetSoftwareVertexProcessing)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetTransform)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetClipPlane)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetViewport)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetScissorRect)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnBeginStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnEndStateBlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetMaterial)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetLight)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetLightEnable)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetRenderTarget)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetDepthStencil)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetTexture)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetTextureStageState)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetSamplerState)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetRenderState)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetPaletteEntries)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetCurrentTexturePalette)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetNPatchMode)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetFVF)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetVertexDecl)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetStreamSource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetStreamSourceFreq)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetIndices)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetShader)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetShaderConstF)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetShaderConstI)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetShaderConstB)
...
static void probe_d3d9_device_arg_structs() {
  print_header("D3D9UMDDI device arg structs");

  print_sizeof("D3D9DDIARG_CREATEDEVICE", sizeof(D3D9DDIARG_CREATEDEVICE));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_CREATEDEVICE, hAdapter)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_CREATEDEVICE, hDevice)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_CREATEDEVICE, Flags)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_CREATEDEVICE, pCallbacks)

  print_sizeof("D3D9DDIARG_LOCK", sizeof(D3D9DDIARG_LOCK));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_LOCK, hResource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_LOCK, OffsetToLock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_LOCK, SizeToLock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_LOCK, Flags)

  print_sizeof("D3D9DDIARG_UNLOCK", sizeof(D3D9DDIARG_UNLOCK));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_UNLOCK, hResource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_UNLOCK, OffsetToUnlock)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_UNLOCK, SizeToUnlock)

  print_sizeof("D3D9DDI_LOCKED_BOX", sizeof(D3D9DDI_LOCKED_BOX));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, pData)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, rowPitch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, slicePitch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, pBits)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, RowPitch)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_LOCKED_BOX, SlicePitch)

  print_sizeof("D3D9DDIARG_PRESENT", sizeof(D3D9DDIARG_PRESENT));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hSrc)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hSrcResource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hDestResource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hSwapChain)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hWnd)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, hWindow)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, SyncInterval)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENT, Flags)

  print_sizeof("D3D9DDIARG_PRESENTEX", sizeof(D3D9DDIARG_PRESENTEX));
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, hSrc)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, hSrcResource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, hWnd)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, hWindow)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, SyncInterval)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDIARG_PRESENTEX, Flags)
}
...
static void probe_device_callbacks() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnCreateDeviceCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnDestroyDeviceCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnCreateContextCb2)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnCreateContextCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnDestroyContextCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnDestroySynchronizationObjectCb)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnGetCommandBufferCb)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnWaitForSynchronizationObjectCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnLockCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnUnlockCb)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDI_DEVICECALLBACKS, pfnSetErrorCb)
}
...
static void probe_submit_structs() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_SUBMITCOMMAND, NewFenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_SUBMITCOMMAND, FenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_SUBMITCOMMAND, pFenceValue)

  // These argument structs are used by the D3D runtime callbacks
  // (D3DDDI_DEVICECALLBACKS::pfnRenderCb / pfnPresentCb) in some WDK vintages.
  // Print them so the UMD can confirm which struct is used.
  print_sizeof("D3DDDIARG_RENDER", sizeof(D3DDDIARG_RENDER));
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, hContext)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pCommandBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, CommandLength)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, CommandBufferSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pAllocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, AllocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pPatchLocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, PatchLocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pNewCommandBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, NewCommandBufferSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pNewAllocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, NewAllocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pNewPatchLocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, NewPatchLocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, SubmissionFenceId)

  print_sizeof("D3DDDIARG_PRESENT", sizeof(D3DDDIARG_PRESENT));
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, hContext)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pCommandBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, CommandLength)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, CommandBufferSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pAllocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, AllocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pPatchLocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, PatchLocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pNewCommandBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, NewCommandBufferSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pNewAllocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, NewAllocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pNewPatchLocationList)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, NewPatchLocationListSize)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, SubmissionFenceId)
}
...
static void probe_submit_callbacks() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_RENDER, NewFenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_RENDER, FenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_RENDER, pFenceValue)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_PRESENT, NewFenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_PRESENT, FenceValue)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_PRESENT, pFenceValue)
