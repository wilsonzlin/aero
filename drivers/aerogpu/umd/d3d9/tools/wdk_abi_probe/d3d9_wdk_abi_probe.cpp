...
AEROGPU_DEFINE_HAS_MEMBER(pfnSetRenderTarget)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetDepthStencil)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetViewport)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetScissorRect)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetTexture)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetSamplerState)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetRenderState)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateVertexDecl)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetVertexDecl)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroyVertexDecl)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateShader)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetShader)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroyShader)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetShaderConstF)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetShaderConstI)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetShaderConstB)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetStreamSource)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetIndices)
AEROGPU_DEFINE_HAS_MEMBER(pfnClear)
AEROGPU_DEFINE_HAS_MEMBER(pfnDrawPrimitive)
AEROGPU_DEFINE_HAS_MEMBER(pfnDrawPrimitiveUP)
AEROGPU_DEFINE_HAS_MEMBER(pfnDrawIndexedPrimitive)
AEROGPU_DEFINE_HAS_MEMBER(pfnCreateSwapChain)
AEROGPU_DEFINE_HAS_MEMBER(pfnDestroySwapChain)
AEROGPU_DEFINE_HAS_MEMBER(pfnGetSwapChain)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetSwapChain)
AEROGPU_DEFINE_HAS_MEMBER(pfnReset)
AEROGPU_DEFINE_HAS_MEMBER(pfnResetEx)
...
AEROGPU_DEFINE_HAS_MEMBER(pfnRotateResourceIdentities)
AEROGPU_DEFINE_HAS_MEMBER(pfnPresent)
AEROGPU_DEFINE_HAS_MEMBER(pfnPresentEx)
AEROGPU_DEFINE_HAS_MEMBER(pfnFlush)
AEROGPU_DEFINE_HAS_MEMBER(pfnSetMaximumFrameLatency)
AEROGPU_DEFINE_HAS_MEMBER(pfnGetMaximumFrameLatency)
AEROGPU_DEFINE_HAS_MEMBER(pfnGetPresentStats)
AEROGPU_DEFINE_HAS_MEMBER(pfnGetLastPresentCount)
...
AEROGPU_DEFINE_HAS_MEMBER(pfnGetRenderTargetData)
AEROGPU_DEFINE_HAS_MEMBER(pfnCopyRects)
...
static void probe_function_tables() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetRenderTarget)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetDepthStencil)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetViewport)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetScissorRect)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetTexture)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetSamplerState)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetRenderState)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnCreateVertexDecl)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetVertexDecl)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDestroyVertexDecl)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnCreateShader)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetShader)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDestroyShader)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetShaderConstF)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetShaderConstI)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetShaderConstB)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetStreamSource)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetIndices)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnClear)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawPrimitive)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawPrimitiveUP)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnDrawIndexedPrimitive)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetSwapChain)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetSwapChain)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnReset)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnResetEx)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetPriority)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetPriority)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetConvolutionMonoKernel)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetAutoGenFilterType)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetAutoGenFilterType)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGenerateMipSubLevels)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnRotateResourceIdentities)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnSetMaximumFrameLatency)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetMaximumFrameLatency)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetPresentStats)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetLastPresentCount)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnGetRenderTargetData)
  AEROGPU_PRINT_MEMBER_OFFSET(D3D9DDI_DEVICEFUNCS, pfnCopyRects)
...
static void probe_submit_structs() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_CREATECONTEXT, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_CREATECONTEXT, DmaBufferSize)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_SUBMITCOMMAND, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_SUBMITCOMMAND, DmaBufferSize)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_RENDER, DmaBufferSize)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDIARG_PRESENT, DmaBufferSize)
...
static void probe_submit_callbacks() {
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_RENDER, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_RENDER, DmaBufferSize)
  ...
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_PRESENT, pDmaBuffer)
  AEROGPU_PRINT_MEMBER_OFFSET(D3DDDICB_PRESENT, DmaBufferSize)
