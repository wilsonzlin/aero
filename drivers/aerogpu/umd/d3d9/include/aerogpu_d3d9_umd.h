...
// Draw*UP DDIs (DrawPrimitive2 / DrawIndexedPrimitive2).
typedef struct AEROGPU_D3D9DDIARG_DRAWPRIMITIVE2 {
  AEROGPU_D3D9DDI_PRIMITIVE_TYPE type;
  uint32_t primitive_count;
  const void* pVertexStreamZeroData;
  uint32_t vertex_stream_zero_stride;
} AEROGPU_D3D9DDIARG_DRAWPRIMITIVE2;

typedef struct AEROGPU_D3D9DDIARG_DRAWINDEXEDPRIMITIVE2 {
  AEROGPU_D3D9DDI_PRIMITIVE_TYPE type;
  uint32_t primitive_count;
  uint32_t min_index;
  uint32_t num_vertices;
  const void* pIndexData;
  AEROGPU_D3D9DDI_INDEX_FORMAT index_format;
  const void* pVertexStreamZeroData;
  uint32_t vertex_stream_zero_stride;
} AEROGPU_D3D9DDIARG_DRAWINDEXEDPRIMITIVE2;
...
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_DESTROYVERTEXDECL)(
    AEROGPU_D3D9DDI_HDEVICE hDevice, AEROGPU_D3D9DDI_HVERTEXDECL hDecl);
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_SETFVF)(
    AEROGPU_D3D9DDI_HDEVICE hDevice, uint32_t fvf);
...
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_BEGINSCENE)(
    AEROGPU_D3D9DDI_HDEVICE hDevice);
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_ENDSCENE)(
    AEROGPU_D3D9DDI_HDEVICE hDevice);
...
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_DRAWPRIMITIVEUP)(
    AEROGPU_D3D9DDI_HDEVICE hDevice,
    AEROGPU_D3D9DDI_PRIMITIVE_TYPE type,
    uint32_t primitive_count,
...
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_DRAWPRIMITIVE2)(
    AEROGPU_D3D9DDI_HDEVICE hDevice, const AEROGPU_D3D9DDIARG_DRAWPRIMITIVE2* pDraw);
typedef HRESULT(AEROGPU_D3D9_CALL* PFN_AEROGPU_D3D9DDI_DRAWINDEXEDPRIMITIVE2)(
    AEROGPU_D3D9DDI_HDEVICE hDevice, const AEROGPU_D3D9DDIARG_DRAWINDEXEDPRIMITIVE2* pDraw);
...
struct AEROGPU_D3D9DDI_DEVICEFUNCS {
  ...
  PFN_AEROGPU_D3D9DDI_SETFVF pfnSetFVF;
  ...
  PFN_AEROGPU_D3D9DDI_BEGINSCENE pfnBeginScene;
  PFN_AEROGPU_D3D9DDI_ENDSCENE pfnEndScene;

  PFN_AEROGPU_D3D9DDI_CLEAR pfnClear;
  PFN_AEROGPU_D3D9DDI_DRAWPRIMITIVE pfnDrawPrimitive;
  PFN_AEROGPU_D3D9DDI_DRAWPRIMITIVEUP pfnDrawPrimitiveUP;
  PFN_AEROGPU_D3D9DDI_DRAWINDEXEDPRIMITIVE pfnDrawIndexedPrimitive;
  PFN_AEROGPU_D3D9DDI_DRAWPRIMITIVE2 pfnDrawPrimitive2;
  PFN_AEROGPU_D3D9DDI_DRAWINDEXEDPRIMITIVE2 pfnDrawIndexedPrimitive2;
