...
:help
echo Usage: run_all.cmd [--dump] [--hidden] [--show] [--validate-sharing] [--no-validate-sharing] [--samples=N] [--iterations=N] [--wait-timeout-ms=N] [--timeout-ms=NNNN] [--no-timeout] [--require-vid=0x####] [--require-did=0x####] [--allow-microsoft] [--allow-non-aerogpu] [--require-umd] [--allow-remote]
echo.
echo Notes:
...
echo   --show affects d3d9ex_shared_surface and d3d9ex_shared_surface_ipc: show the parent window (overrides --hidden).
