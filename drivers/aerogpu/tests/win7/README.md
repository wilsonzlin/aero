...
* `d3d9ex_ps_only_triangle` draws a D3D9Ex triangle using a simple `ps_2_0` pixel shader with **NULL vertex shader** (fixed-function vertex processing) and validates via readback: **corner red + center blue** (catches shader pipeline / color channel-order regressions)
