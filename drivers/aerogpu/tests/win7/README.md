...
* `d3d9ex_vb_dirty_range` renders a green triangle using a vertex buffer upload path and confirms **corner red + center green** via readback (catches regressions in vertex-buffer dirty-range tracking / upload)
