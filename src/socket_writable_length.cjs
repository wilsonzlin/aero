...
function socketWritableLengthOrOverflow(socket, max) {
...
function socketWritableLengthExceedsCap(socket, max) {
  const cap = normalizeCap(max);
...
module.exports = { socketWritableLengthOrOverflow, socketWritableLengthExceedsCap };
