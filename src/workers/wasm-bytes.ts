...
export const JIT_BIGINT_ABI_WASM_BYTES = new Uint8Array([
  ...
  0xf4, 0x01, 0x0d, 0x03, 0x65, 0x6e, 0x76, 0x06, 0x6d, 0x65, 0x6d, 0x6f,
  0x72, 0x79, 0x02, 0x03, 0x01, 0x80, 0x80, 0x04, 0x03, 0x65, 0x6e, 0x76, 0x0b, 0x6d,
  ...
  // Return the Tier-1 sentinel (-1) after triggering runtime exits so JS host glue can validate
  // rollback/commit semantics without treating this as a committed return.
  0x20, 0x00, 0x42, 0x7f, 0x10, 0x0b, 0x0b,
]) as Uint8Array<ArrayBuffer>;

// Minimal module exporting `block(cpu_ptr: i32, jit_ctx_ptr: i32) -> i64` and importing just
// `env.code_page_version(cpu_ptr: i32, page: i64) -> i64` so we can validate wasm i64 ↔ JS BigInt
// handling for that import without dragging in the full Tier-2 fixture.
export const JIT_CODE_PAGE_VERSION_ABI_WASM_BYTES = new Uint8Array([
  0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x0d, 0x02, 0x60, 0x02, 0x7f, 0x7e, 0x01,
  0x7e, 0x60, 0x02, 0x7f, 0x7f, 0x01, 0x7e, 0x02, 0x19, 0x01, 0x03, 0x65, 0x6e, 0x76, 0x11,
  0x63, 0x6f, 0x64, 0x65, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69,
  0x6f, 0x6e, 0x00, 0x00, 0x03, 0x02, 0x01, 0x01, 0x07, 0x09, 0x01, 0x05, 0x62, 0x6c, 0x6f,
  0x63, 0x6b, 0x00, 0x01, 0x0a, 0x0a, 0x01, 0x08, 0x00, 0x20, 0x00, 0x42, 0x7f, 0x10, 0x00,
  0x0b,
]) as Uint8Array<ArrayBuffer>;
