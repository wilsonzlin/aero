...
bash ./scripts/safe-run.sh wasm-pack test --node crates/aero-wasm --test webusb_uhci_bridge --test xhci_webusb_bridge --test xhci_webusb_snapshot --test usb_bridge_snapshot_roundtrip --test usb_snapshot --test machine_input_injection_wasm --test usb_hid_bridge_mouse_reports_wasm --test usb_hid_bridge_consumer_reports_wasm --test webhid_interrupt_out_policy_wasm --test webhid_report_descriptor_synthesis_wasm --locked
