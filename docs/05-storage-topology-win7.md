...
- `crates/aero-machine/tests/win7_storage_topology.rs` (guard: canonical storage BDFs + PCI Interrupt Line/Pin + IDE legacy BAR ranges + key BAR definitions + optional NVMe BDF/Interrupt Line when enabled)
