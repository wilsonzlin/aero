...
; Canonical keyboard/mouse INF includes explicit keyboard/mouse model lines for distinct
; Device Manager naming, plus a strict revision-gated generic fallback model line (no SUBSYS):
