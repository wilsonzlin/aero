...
- Or use **Audio → “Export audio QA bundle (tar)”** to download a single archive containing:
  ...
  - `microphone-buffered.json` (best-effort; metadata for the mic WAV snapshot: sample rate, samples captured, ring counters, and quick signal stats like RMS/peak)
