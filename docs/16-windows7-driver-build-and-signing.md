...
>   - **SUBSYS-only**: matches only the subsystem-qualified keyboard/mouse contract v1 HWIDs (`SUBSYS_0010` / `SUBSYS_0011`, both
>     `&REV_01`) for distinct Device Manager names.
