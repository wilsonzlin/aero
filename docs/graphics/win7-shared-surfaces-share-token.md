...
- This escape is disabled by default; enable via `HKLM\\SYSTEM\\CurrentControlSet\\Services\\aerogpu\\Parameters\\EnableMapSharedHandleEscape = 1` (`REG_DWORD`) and reboot/reload the driver (see `drivers/aerogpu/tools/win7_dbgctl/README.md`).
