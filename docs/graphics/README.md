...
- `win7-d3d9-fixedfunc-wvp.md` — task doc: finish draw-time fixed-function WVP transforms for untextured `D3DFVF_XYZ | D3DFVF_DIFFUSE` (gap tracking + implementation notes).
