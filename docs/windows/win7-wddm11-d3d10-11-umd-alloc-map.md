...
* `docs/graphics/win7-d3d10-11-umd-allocations.md` — the Win7 WDK 7.1 resource-allocation contract (`CreateResource` → `pfnAllocateCb` / `pfnDeallocateCb`, `D3DDDI_ALLOCATIONINFO`, DXGI primary flags).
