...
> not an unexpected legacy INTx interrupt. This behavior is exercised by
> `crates/aero-virtio/tests/virtio_blk.rs::virtio_blk_msix_queue_interrupts_use_programmed_msix_message_and_do_not_fallback_to_intx`.
