...
If a large open-source fixture truly needs to live in-repo, it must be explicitly allowlisted in `scripts/ci/check-repo-policy.sh` with a clear justification.
