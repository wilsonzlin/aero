...
- `assets/bios.bin` (generated fixture; canonical ROM comes from `firmware::bios::build_bios_rom()`; see [`assets/README.md`](../assets/README.md); regenerate via `cargo xtask bios-rom` (or `cargo xtask fixtures`, or `cargo run -p firmware --bin gen_bios_rom --locked`))
...
- `tests/fixtures/boot/int_sanity.bin` (tiny BIOS interrupt sanity boot sector generated by `cargo xtask fixtures`; the original `.asm` source is kept in-repo as documentation)
