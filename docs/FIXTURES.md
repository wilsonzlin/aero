...
- `assets/bios.bin` (open-source BIOS binary built from this repo; regenerated by `cargo xtask fixtures`)
- `crates/firmware/acpi/dsdt.aml` (ACPI DSDT AML built from this repo; regenerated by `cargo xtask fixtures`)
