...
# Prefer the most specific Win7 dir when multiple are present.
# (Some virtio-win releases include both "w7" and "w7.1"; we target Win7 SP1.)
OS_FOLDER_CANDIDATES = ["w7.1", "w7_1", "w7", "win7"]
