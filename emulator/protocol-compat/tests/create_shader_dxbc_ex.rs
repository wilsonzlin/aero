...
fn create_shader_dxbc_ex_encodes_stage_ex_in_reserved0() {
    ...
    // The returned cmd is a packed C-style struct, so copy fields into locals before asserting.
